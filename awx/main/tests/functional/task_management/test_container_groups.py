...
def test_containerized_job(containerized_job):
    with mock.patch('awx.main.scheduler.kubernetes.PodManager.deploy_pod') as deploy_pod:
        deploy_pod.return_value = mock.Mock(pod_name='my-pod')
        TaskManager().schedule()
        assert deploy_pod.called
